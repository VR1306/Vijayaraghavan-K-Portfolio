...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-9 w-9 cursor-pointer items-center justify-center border border-line/15 text-ink transition-colors hover:border-accent hover:text-accent-bright"
    >
      {mounted ? (
        isDark ? (
